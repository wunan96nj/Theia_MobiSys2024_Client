...
#include "BP_CoffeeCup__pf2124240069.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/UXToolsExamples/BoundsControl/Blueprints/BP_CoffeeCup.BP_CoffeeCup_C", OverrideNativeName="BP_CoffeeCup_C"))
class ABP_CoffeeCup_C__pf2124240069 : public AActor
{
public:
	GENERATED_BODY()
	...
	ABP_CoffeeCup_C__pf2124240069(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_CoffeeCup__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_CoffeeCup__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_CoffeeCup__pf_2(int32 bpp__EntryPoint__pf);
