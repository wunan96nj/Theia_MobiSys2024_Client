...
#include "BP_LoaderButton__pf1183508669.h"
...
ABP_LoaderButton_C__pf1183508669::ABP_LoaderButton_C__pf1183508669(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__5)
	{
		...
		__Local__23 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_LoaderButton_C__pf1183508669::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
		__Local__5->OverrideMaterials = TArray<UMaterialInterface*> ();
		__Local__5->OverrideMaterials.Reserve(1);
		__Local__5->OverrideMaterials.Add(CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_LoaderButton_C__pf1183508669::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed));
		auto& __Local__24 = (*(AccessPrivateProperty<USceneComponent*>((__Local__5), USceneComponent::__PPO__AttachParent() )));
		__Local__24 = __Local__4;
	...
	if(__Local__6)
	{
		...
		auto& __Local__27 = (*(AccessPrivateProperty<USceneComponent*>((__Local__6), USceneComponent::__PPO__AttachParent() )));
		__Local__27 = __Local__4;
		...
		(((FBoolProperty*)__Local__28)->SetPropertyValue_InContainer((__Local__6), false, 0));
		// --- END default subobject 'Icon' //
	}
	if(__Local__7)
	{
		// --- Default subobject 'Label' //
		auto& __Local__30 = (*(AccessPrivateProperty<USceneComponent*>((__Local__7), USceneComponent::__PPO__AttachParent() )));
		...
		(((FBoolProperty*)__Local__31)->SetPropertyValue_InContainer((__Local__7), false, 0));
		// --- END default subobject 'Label' //
	}
	if(__Local__8)
	{
		// --- Default subobject 'Audio' //
		auto& __Local__33 = (*(AccessPrivateProperty<UUxtPressableButtonComponent*>((__Local__8), USceneComponent::__PPO__AttachParent() )));
		...
		(((FBoolProperty*)__Local__34)->SetPropertyValue_InContainer((__Local__8), false, 0));
...
void ABP_LoaderButton_C__pf1183508669::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_LoaderButton_C__pf1183508669::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_LoaderButton_C__pf1183508669::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_LoaderButton_C__pf1183508669::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_LoaderButton_C__pf1183508669
{
	FRegisterHelper__ABP_LoaderButton_C__pf1183508669()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/UXToolsExamples/Loader/Blueprints/BP_LoaderButton"), &ABP_LoaderButton_C__pf1183508669::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_LoaderButton_C__pf1183508669 Instance;
};
FRegisterHelper__ABP_LoaderButton_C__pf1183508669 FRegisterHelper__ABP_LoaderButton_C__pf1183508669::Instance;
