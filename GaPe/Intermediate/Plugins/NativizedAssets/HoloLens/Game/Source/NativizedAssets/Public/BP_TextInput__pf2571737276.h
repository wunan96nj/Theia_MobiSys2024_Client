...
#include "BP_TextInput__pf2571737276.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/UXToolsExamples/Widget/Blueprints/BP_TextInput.BP_TextInput_C", OverrideNativeName="BP_TextInput_C"))
class ABP_TextInput_C__pf2571737276 : public AActor
{
public:
	GENERATED_BODY()
	...
	ABP_TextInput_C__pf2571737276(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
