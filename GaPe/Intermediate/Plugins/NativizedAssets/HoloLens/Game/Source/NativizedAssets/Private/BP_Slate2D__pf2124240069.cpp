...
#include "BP_Slate2D__pf2124240069.h"
...
ABP_Slate2D_C__pf2124240069::ABP_Slate2D_C__pf2124240069(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer)
{
	...
	auto& __Local__2 = (*(AccessPrivateProperty<UStaticMesh* >((bpv__BoundControl__pf), UStaticMeshComponent::__PPO__StaticMesh() )));
	__Local__2 = CastChecked<UStaticMesh>(CastChecked<UDynamicClass>(ABP_Slate2D_C__pf2124240069::StaticClass())->UsedAssets[0], ECastCheckedType::NullAllowed);
	auto& __Local__3 = (*(AccessPrivateProperty<FVector >((bpv__BoundControl__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__3 = FVector(0.050000, 0.000000, 0.000000);
	auto& __Local__4 = (*(AccessPrivateProperty<FRotator >((bpv__BoundControl__pf), USceneComponent::__PPO__RelativeRotation() )));
	__Local__4 = FRotator(90.000000, 0.000000, 179.999924);
	auto& __Local__5 = (*(AccessPrivateProperty<FVector >((bpv__BoundControl__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__5 = FVector(0.100010, 11.249997, 11.249999);
	...
	auto& __Local__6 = (*(AccessPrivateProperty<FVector >((bpv__UxtBackPlate__pf), USceneComponent::__PPO__RelativeScale3D() )));
	__Local__6 = FVector(1.600000, 11.250000, 11.250000);
	...
	bpv__UxtBoundsControl__pf->Config = CastChecked<UUxtBoundsControlConfig>(CastChecked<UDynamicClass>(ABP_Slate2D_C__pf2124240069::StaticClass())->UsedAssets[1], ECastCheckedType::NullAllowed);
	...
	bpv__GrabbedSound__pf = CastChecked<USoundBase>(CastChecked<UDynamicClass>(ABP_Slate2D_C__pf2124240069::StaticClass())->UsedAssets[2], ECastCheckedType::NullAllowed);
	bpv__ReleasedSound__pf = CastChecked<USoundBase>(CastChecked<UDynamicClass>(ABP_Slate2D_C__pf2124240069::StaticClass())->UsedAssets[3], ECastCheckedType::NullAllowed);
	bpv__BoundsMaterial__pf = CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Slate2D_C__pf2124240069::StaticClass())->UsedAssets[4], ECastCheckedType::NullAllowed);
	bpv__BoundsGrabbedMaterial__pf = CastChecked<UMaterialInterface>(CastChecked<UDynamicClass>(ABP_Slate2D_C__pf2124240069::StaticClass())->UsedAssets[5], ECastCheckedType::NullAllowed);
...
void ABP_Slate2D_C__pf2124240069::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Slate2D_C__pf2124240069::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	__Local__8->ComponentDelegateBindings.AddUninitialized(4);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__8->ComponentDelegateBindings.GetData(), 4);
	auto& __Local__9 = __Local__8->ComponentDelegateBindings[0];
	__Local__9.ComponentPropertyName = FName(TEXT("UxtGenericManipulator"));
	__Local__9.DelegatePropertyName = FName(TEXT("OnEndGrab"));
	__Local__9.FunctionNameToBind = FName(TEXT("BndEvt__UxtGenericManipulator_K2Node_ComponentBoundEvent_3_UxtEndGrabDelegate__DelegateSignature"));
	auto& __Local__10 = __Local__8->ComponentDelegateBindings[1];
	__Local__10.ComponentPropertyName = FName(TEXT("UxtGenericManipulator"));
	__Local__10.DelegatePropertyName = FName(TEXT("OnBeginGrab"));
	__Local__10.FunctionNameToBind = FName(TEXT("BndEvt__UxtGenericManipulator_K2Node_ComponentBoundEvent_2_UxtBeginGrabDelegate__DelegateSignature"));
	auto& __Local__11 = __Local__8->ComponentDelegateBindings[2];
	__Local__11.ComponentPropertyName = FName(TEXT("UxtBoundsControl"));
	__Local__11.DelegatePropertyName = FName(TEXT("OnManipulationEnded"));
	__Local__11.FunctionNameToBind = FName(TEXT("BndEvt__UxtBoundsControl_K2Node_ComponentBoundEvent_1_UxtBoundsControlManipulationEndedDelegate__DelegateSignature"));
	auto& __Local__12 = __Local__8->ComponentDelegateBindings[3];
	__Local__12.ComponentPropertyName = FName(TEXT("UxtBoundsControl"));
	__Local__12.DelegatePropertyName = FName(TEXT("OnManipulationStarted"));
	__Local__12.FunctionNameToBind = FName(TEXT("BndEvt__UxtBoundsControl_K2Node_ComponentBoundEvent_0_UxtBoundsControlManipulationStartedDelegate__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_Slate2D_C__pf2124240069::bpf__ExecuteUbergraph_BP_Slate2D__pf_0(int32 bpp__EntryPoint__pf)
{
...
void ABP_Slate2D_C__pf2124240069::bpf__ExecuteUbergraph_BP_Slate2D__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_Slate2D_C__pf2124240069::bpf__ExecuteUbergraph_BP_Slate2D__pf_2(int32 bpp__EntryPoint__pf)
{
...
void ABP_Slate2D_C__pf2124240069::bpf__BndEvt__UxtGenericManipulator_K2Node_ComponentBoundEvent_3_UxtEndGrabDelegate__DelegateSignature__pf(UUxtGrabTargetComponent* bpp__Grabbable__pf, FUxtGrabPointerData bpp__GrabPointer__pf)
{
	...
	bpf__ExecuteUbergraph_BP_Slate2D__pf_1(10);
}
void ABP_Slate2D_C__pf2124240069::bpf__BndEvt__UxtGenericManipulator_K2Node_ComponentBoundEvent_2_UxtBeginGrabDelegate__DelegateSignature__pf(UUxtGrabTargetComponent* bpp__Grabbable__pf, FUxtGrabPointerData bpp__GrabPointer__pf)
{
	...
	bpf__ExecuteUbergraph_BP_Slate2D__pf_0(9);
}
void ABP_Slate2D_C__pf2124240069::bpf__BndEvt__UxtBoundsControl_K2Node_ComponentBoundEvent_1_UxtBoundsControlManipulationEndedDelegate__DelegateSignature__pf(UUxtBoundsControlComponent* bpp__Manipulator__pf, FUxtAffordanceConfig const& bpp__AffordanceInfo__pf__const, UUxtGrabTargetComponent* bpp__GrabbedComponent__pf)
{
	...
	bpf__ExecuteUbergraph_BP_Slate2D__pf_1(6);
}
void ABP_Slate2D_C__pf2124240069::bpf__BndEvt__UxtBoundsControl_K2Node_ComponentBoundEvent_0_UxtBoundsControlManipulationStartedDelegate__DelegateSignature__pf(UUxtBoundsControlComponent* bpp__Manipulator__pf, FUxtAffordanceConfig const& bpp__AffordanceInfo__pf__const, UUxtGrabTargetComponent* bpp__GrabbedComponent__pf)
{
	typedef FUxtAffordanceConfig  T__Local__14;
	T__Local__14& bpp__AffordanceInfo__pf = *const_cast<T__Local__14 *>(&bpp__AffordanceInfo__pf__const);
	...
	bpf__ExecuteUbergraph_BP_Slate2D__pf_0(3);
}
void ABP_Slate2D_C__pf2124240069::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_Slate2D__pf_2(1);
}
void ABP_Slate2D_C__pf2124240069::bpf__UserConstructionScript__pf()
{
	...
	UKismetSystemLibrary::GetComponentBounds(bpv__UxtBackPlate__pf, /*out*/ bpfv__CallFunc_GetComponentBounds_Origin__pf, /*out*/ bpfv__CallFunc_GetComponentBounds_BoxExtent__pf, /*out*/ bpfv__CallFunc_GetComponentBounds_SphereRadius__pf);
	if(::IsValid(bpv__UxtBackPlate__pf))
	{
		bpfv__CallFunc_K2_GetComponentToWorld_ReturnValue__pf = bpv__UxtBackPlate__pf->USceneComponent::K2_GetComponentToWorld();
	}
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Slate2D_C__pf2124240069::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{216, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  UxtBoundsControlConfig /UXTools/BoundsControl/Presets/BoundsControlSlate2D.BoundsControlSlate2D 
...
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_Slate2D_C__pf2124240069::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_Slate2D_C__pf2124240069
{
	FRegisterHelper__ABP_Slate2D_C__pf2124240069()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/UXToolsExamples/BoundsControl/Blueprints/BP_Slate2D"), &ABP_Slate2D_C__pf2124240069::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_Slate2D_C__pf2124240069 Instance;
};
FRegisterHelper__ABP_Slate2D_C__pf2124240069 FRegisterHelper__ABP_Slate2D_C__pf2124240069::Instance;
