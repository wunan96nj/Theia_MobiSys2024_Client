...
#include "BP_ScrollingObjectCollection__pf3034317442.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/UXToolsExamples/ScrollingObjectCollection/Blueprints/BP_ScrollingObjectCollection.BP_ScrollingObjectCollection_C", OverrideNativeName="BP_ScrollingObjectCollection_C"))
class ABP_ScrollingObjectCollection_C__pf3034317442 : public AActor
{
public:
	GENERATED_BODY()
	...
	ABP_ScrollingObjectCollection_C__pf3034317442(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_ScrollingObjectCollection__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_ScrollingObjectCollection__pf_1(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_ScrollingObjectCollection__pf_2(int32 bpp__EntryPoint__pf);
	...
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="SetButtonMask"))
	virtual void bpf__SetButtonMask__pf();
	UFUNCTION(BlueprintCallable, meta=(Category, OverrideNativeName="UpdateButtonMask"))
	virtual void bpf__UpdateButtonMask__pf();
public:
};
