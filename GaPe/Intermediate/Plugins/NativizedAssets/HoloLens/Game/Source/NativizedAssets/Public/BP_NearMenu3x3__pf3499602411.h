...
#include "BP_NearMenu3x3__pf3499602411.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/UXToolsExamples/NearMenu/Blueprints/BP_NearMenu3x3.BP_NearMenu3x3_C", OverrideNativeName="BP_NearMenu3x3_C"))
class ABP_NearMenu3x3_C__pf3499602411 : public ABP_NearMenuBase_C__pf3547134495
{
public:
	GENERATED_BODY()
	UPROPERTY(BlueprintReadWrite, NonTransactional, meta=(Category="Default", OverrideNativeName="Button_09"))
	UChildActorComponent* bpv__Button_09__pf;
	...
	ABP_NearMenu3x3_C__pf3499602411(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
