...
#include "BP_PageByButton__pf3034317442.h"
...
ABP_PageByButton_C__pf3034317442::ABP_PageByButton_C__pf3034317442(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	bpv__AnimatexToxPage__pfTT = true;
	...
	auto& __Local__35 = (*(AccessPrivateProperty<EActorUpdateOverlapsMethod >((this), AActor::__PPO__DefaultUpdateOverlapsMethodDuringLevelStreaming() )));
	__Local__35 = EActorUpdateOverlapsMethod::OnlyUpdateMovable;
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_PageByButton_C__pf3034317442::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PageByButton_C__pf3034317442::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	auto __Local__36 = NewObject<USceneComponent>(InDynamicClass, USceneComponent::StaticClass(), TEXT("DefaultSceneRoot_GEN_VARIABLE"), (EObjectFlags)0x00280029);
	InDynamicClass->ComponentTemplates.Add(__Local__36);
	auto __Local__37 = NewObject<UComponentDelegateBinding>(InDynamicClass, UComponentDelegateBinding::StaticClass(), TEXT("ComponentDelegateBinding_1"), (EObjectFlags)0x00000000);
	...
	(((FBoolProperty*)__Local__38)->SetPropertyValue_InContainer((__Local__36), false, 0));
	__Local__37->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__37->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__37->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__40 = __Local__37->ComponentDelegateBindings[0];
	__Local__40.ComponentPropertyName = FName(TEXT("ButtonComponent"));
	__Local__40.DelegatePropertyName = FName(TEXT("OnButtonPressed"));
	__Local__40.FunctionNameToBind = FName(TEXT("BndEvt__ButtonComponent_K2Node_ComponentBoundEvent_1_UxtButtonPressedDelegate__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_PageByButton_C__pf3034317442::bpf__ExecuteUbergraph_BP_PageByButton__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	{
		bpv__ScrollingObjectCollection__pf->bpv__UxtScrollingObjectCollection__pf->UUxtScrollingObjectCollection::PageBy(bpv__PageBy__pf, bpv__AnimatexToxPage__pfTT, b0l__Temp_delegate_Variable__pf);
	}
	return; // KCST_GotoReturn
}
void ABP_PageByButton_C__pf3034317442::bpf__BndEvt__ButtonComponent_K2Node_ComponentBoundEvent_1_UxtButtonPressedDelegate__DelegateSignature__pf(UUxtPressableButtonComponent* bpp__Button__pf, UUxtPointerComponent* bpp__Pointer__pf)
{
	b0l__K2Node_ComponentBoundEvent_Button__pf = bpp__Button__pf;
	b0l__K2Node_ComponentBoundEvent_Pointer__pf = bpp__Pointer__pf;
	bpf__ExecuteUbergraph_BP_PageByButton__pf_0(1);
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PageByButton_C__pf3034317442::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_PageByButton_C__pf3034317442::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{156, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  DelegateFunction /Script/UXTools.UxtScrollingObjectCollectionOnPaginationEnd__DelegateSignature 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_PageByButton_C__pf3034317442
{
	FRegisterHelper__ABP_PageByButton_C__pf3034317442()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/UXToolsExamples/ScrollingObjectCollection/Blueprints/BP_PageByButton"), &ABP_PageByButton_C__pf3034317442::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_PageByButton_C__pf3034317442 Instance;
};
FRegisterHelper__ABP_PageByButton_C__pf3034317442 FRegisterHelper__ABP_PageByButton_C__pf3034317442::Instance;
