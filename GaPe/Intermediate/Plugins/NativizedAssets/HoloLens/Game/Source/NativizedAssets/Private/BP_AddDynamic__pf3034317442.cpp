...
#include "BP_AddDynamic__pf3034317442.h"
...
#include "BP_ScrollingObjectCollection__pf3034317442.h"
...
ABP_AddDynamic_C__pf3034317442::ABP_AddDynamic_C__pf3034317442(const FObjectInitializer& ObjectInitializer) : Super()
{
	...
	if(__Local__1)
	{
		...
		auto& __Local__11 = (*(AccessPrivateProperty<UUxtPressableButtonComponent*>((__Local__1), USceneComponent::__PPO__AttachParent() )));
	...
	if(__Local__2)
	{
		...
		auto& __Local__14 = (*(AccessPrivateProperty<USceneComponent*>((__Local__2), USceneComponent::__PPO__AttachParent() )));
		...
		(((FBoolProperty*)__Local__15)->SetPropertyValue_InContainer((__Local__2), true, 0));
		// --- END default subobject 'BackPlate' //
	}
	if(__Local__3)
	{
		// --- Default subobject 'FrontPlatePivot' //
		auto& __Local__17 = (*(AccessPrivateProperty<UUxtPressableButtonComponent*>((__Local__3), USceneComponent::__PPO__AttachParent() )));
		...
		(((FBoolProperty*)__Local__18)->SetPropertyValue_InContainer((__Local__3), false, 0));
		// --- END default subobject 'FrontPlatePivot' //
	}
	if(__Local__4)
	{
		// --- Default subobject 'FrontPlateCenter' //
		auto& __Local__20 = (*(AccessPrivateProperty<USceneComponent*>((__Local__4), USceneComponent::__PPO__AttachParent() )));
		...
		(((FBoolProperty*)__Local__21)->SetPropertyValue_InContainer((__Local__4), false, 0));
		// --- END default subobject 'FrontPlateCenter' //
	}
	if(__Local__5)
	{
		// --- Default subobject 'FrontPlate' //
		auto& __Local__23 = (*(AccessPrivateProperty<USceneComponent*>((__Local__5), USceneComponent::__PPO__AttachParent() )));
		...
		(((FBoolProperty*)__Local__24)->SetPropertyValue_InContainer((__Local__5), true, 0));
		// --- END default subobject 'FrontPlate' //
	}
	if(__Local__6)
	{
		// --- Default subobject 'Icon' //
		auto& __Local__26 = (*(AccessPrivateProperty<USceneComponent*>((__Local__6), USceneComponent::__PPO__AttachParent() )));
		__Local__26 = __Local__4;
		...
		(((FBoolProperty*)__Local__27)->SetPropertyValue_InContainer((__Local__6), false, 0));
		// --- END default subobject 'Icon' //
	}
	if(__Local__7)
	{
		// --- Default subobject 'Label' //
		auto& __Local__29 = (*(AccessPrivateProperty<USceneComponent*>((__Local__7), USceneComponent::__PPO__AttachParent() )));
		__Local__29 = __Local__4;
		...
		(((FBoolProperty*)__Local__30)->SetPropertyValue_InContainer((__Local__7), false, 0));
		// --- END default subobject 'Label' //
	}
	if(__Local__8)
	{
		// --- Default subobject 'Audio' //
		auto& __Local__32 = (*(AccessPrivateProperty<UUxtPressableButtonComponent*>((__Local__8), USceneComponent::__PPO__AttachParent() )));
		...
		(((FBoolProperty*)__Local__33)->SetPropertyValue_InContainer((__Local__8), false, 0));
	...
	auto& __Local__35 = (*(AccessPrivateProperty<FVector >((bpv__Spline__pf), USceneComponent::__PPO__RelativeLocation() )));
	__Local__35 = FVector(-0.000001, 0.000000, -6.254444);
	...
	(((FBoolProperty*)__Local__36)->SetPropertyValue_InContainer((bpv__Spline__pf), false, 0));
	bpv__Timeline_0_NewTrack_0_DC30AA7C4DAD634AE7EF278E3F578212__pf = 0.000000f;
	bpv__Timeline_0__Direction_DC30AA7C4DAD634AE7EF278E3F578212__pf = ETimelineDirection::Type::Forward;
	bpv__Timeline_0__pf = nullptr;
	bpv__ScrollingObjectCollection__pf = nullptr;
	bpv__Buttons__pf = TArray<AUxtPressableButtonActor*> ();
...
void ABP_AddDynamic_C__pf3034317442::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
...
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AddDynamic_C__pf3034317442::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
	...
	InDynamicClass->ReferencedConvertedFields.Add(ABP_ScrollingObjectCollection_C__pf3034317442::StaticClass());
	...
	auto __Local__40 = NewObject<UTimelineTemplate>(InDynamicClass, UTimelineTemplate::StaticClass(), TEXT("Timeline_0_Template"), (EObjectFlags)0x00280008);
	InDynamicClass->Timelines.Add(__Local__40);
	...
	(((FBoolProperty*)__Local__42)->SetPropertyValue_InContainer((__Local__39), false, 0));
	__Local__40->TimelineLength = 8.000000f;
	__Local__40->FloatTracks = TArray<FTTFloatTrack> ();
	__Local__40->FloatTracks.AddUninitialized(1);
	FTTFloatTrack::StaticStruct()->InitializeStruct(__Local__40->FloatTracks.GetData(), 1);
	auto& __Local__44 = __Local__40->FloatTracks[0];
	auto __Local__45 = NewObject<UCurveFloat>(InDynamicClass, UCurveFloat::StaticClass(), TEXT("CurveFloat_0"), (EObjectFlags)0x00280009);
	...
	__Local__47.Time = 8.000000f;
	__Local__47.Value = 2.000000f;
	__Local__44.CurveFloat = __Local__45;
	auto& __Local__48 = (*(AccessPrivateProperty<FName >(&(__Local__44), FTTPropertyTrack::__PPO__PropertyName() )));
	__Local__48 = FName(TEXT("Timeline_0_NewTrack_0_DC30AA7C4DAD634AE7EF278E3F578212"));
	auto& __Local__49 = (*(AccessPrivateProperty<FName >(&(__Local__44), FTTTrackBase::__PPO__TrackName() )));
	__Local__49 = FName(TEXT("NewTrack_0"));
	__Local__40->TimelineGuid = FGuid(0xDC30AA7C, 0x4DAD634A, 0xE7EF278E, 0x3F578212);
	auto& __Local__50 = (*(AccessPrivateProperty<FName >((__Local__40), UTimelineTemplate::__PPO__VariableName() )));
	__Local__50 = FName(TEXT("Timeline_0"));
	auto& __Local__51 = (*(AccessPrivateProperty<FName >((__Local__40), UTimelineTemplate::__PPO__DirectionPropertyName() )));
	__Local__51 = FName(TEXT("Timeline_0__Direction_DC30AA7C4DAD634AE7EF278E3F578212"));
	auto& __Local__52 = (*(AccessPrivateProperty<FName >((__Local__40), UTimelineTemplate::__PPO__UpdateFunctionName() )));
	__Local__52 = FName(TEXT("Timeline_0__UpdateFunc"));
	auto& __Local__53 = (*(AccessPrivateProperty<FName >((__Local__40), UTimelineTemplate::__PPO__FinishedFunctionName() )));
	__Local__53 = FName(TEXT("Timeline_0__FinishedFunc"));
	__Local__41->ComponentDelegateBindings = TArray<FBlueprintComponentDelegateBinding> ();
	__Local__41->ComponentDelegateBindings.AddUninitialized(1);
	FBlueprintComponentDelegateBinding::StaticStruct()->InitializeStruct(__Local__41->ComponentDelegateBindings.GetData(), 1);
	auto& __Local__54 = __Local__41->ComponentDelegateBindings[0];
	__Local__54.ComponentPropertyName = FName(TEXT("ButtonComponent"));
	__Local__54.DelegatePropertyName = FName(TEXT("OnButtonPressed"));
	__Local__54.FunctionNameToBind = FName(TEXT("BndEvt__ButtonComponent_K2Node_ComponentBoundEvent_0_UxtButtonPressedDelegate__DelegateSignature"));
}
PRAGMA_ENABLE_OPTIMIZATION
void ABP_AddDynamic_C__pf3034317442::bpf__ExecuteUbergraph_BP_AddDynamic__pf_0(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 20);
	return; //KCST_EndOfThread
}
void ABP_AddDynamic_C__pf3034317442::bpf__ExecuteUbergraph_BP_AddDynamic__pf_1(int32 bpp__EntryPoint__pf)
{
...
void ABP_AddDynamic_C__pf3034317442::bpf__ExecuteUbergraph_BP_AddDynamic__pf_2(int32 bpp__EntryPoint__pf)
{
...
void ABP_AddDynamic_C__pf3034317442::bpf__ExecuteUbergraph_BP_AddDynamic__pf_3(int32 bpp__EntryPoint__pf)
{
	check(bpp__EntryPoint__pf == 17);
	// optimized KCST_UnconditionalGoto
	bpf__DoTransition__pf(bpv__Timeline_0_NewTrack_0_DC30AA7C4DAD634AE7EF278E3F578212__pf);
	return; //KCST_EndOfThread
}
void ABP_AddDynamic_C__pf3034317442::bpf__BndEvt__ButtonComponent_K2Node_ComponentBoundEvent_0_UxtButtonPressedDelegate__DelegateSignature__pf(UUxtPressableButtonComponent* bpp__Button__pf, UUxtPointerComponent* bpp__Pointer__pf)
{
	b0l__K2Node_ComponentBoundEvent_Button__pf = bpp__Button__pf;
	b0l__K2Node_ComponentBoundEvent_Pointer__pf = bpp__Pointer__pf;
	bpf__ExecuteUbergraph_BP_AddDynamic__pf_2(1);
}
void ABP_AddDynamic_C__pf3034317442::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_BP_AddDynamic__pf_1(18);
}
void ABP_AddDynamic_C__pf3034317442::bpf__Timeline_0__UpdateFunc__pf()
{
	bpf__ExecuteUbergraph_BP_AddDynamic__pf_3(17);
}
void ABP_AddDynamic_C__pf3034317442::bpf__Timeline_0__FinishedFunc__pf()
{
	bpf__ExecuteUbergraph_BP_AddDynamic__pf_0(20);
}
void ABP_AddDynamic_C__pf3034317442::bpf__DoTransition__pf(float bpp__Time__pf)
{
	...
	int32 bpfv__CallFunc_Add_IntInt_ReturnValue__pf{};
	int32 bpfv__CallFunc_Array_Length_ReturnValue__pf{};
	AUxtPressableButtonActor* bpfv__CallFunc_Array_Get_Item__pf{};
	...
	do
	{
		...
		case 3:
			{
				bpfv__CallFunc_Array_Length_ReturnValue_1__pf = FCustomThunkTemplates::Array_Length(bpv__Buttons__pf);
		...
		case 6:
			{
				bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf = UKismetMathLibrary::Conv_IntToFloat(bpfv__Temp_int_Array_Index_Variable__pf);
				bpfv__CallFunc_Array_Length_ReturnValue__pf = FCustomThunkTemplates::Array_Length(bpv__Buttons__pf);
				bpfv__CallFunc_Conv_IntToFloat_ReturnValue_1__pf = UKismetMathLibrary::Conv_IntToFloat(bpfv__CallFunc_Array_Length_ReturnValue__pf);
				bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf = FCustomThunkTemplates::Divide_FloatFloat(bpfv__CallFunc_Conv_IntToFloat_ReturnValue__pf, bpfv__CallFunc_Conv_IntToFloat_ReturnValue_1__pf);
				bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpp__Time__pf, bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf);
				bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf, 0.000000, 1.000000);
				bpfv__CallFunc_GreaterEqual_FloatFloat_ReturnValue__pf = UKismetMathLibrary::GreaterEqual_FloatFloat(bpfv__CallFunc_FClamp_ReturnValue__pf, 1.000000);
		...
		case 7:
			{
				FCustomThunkTemplates::Array_Get(bpv__Buttons__pf, bpfv__Temp_int_Array_Index_Variable__pf, /*out*/ bpfv__CallFunc_Array_Get_Item__pf);
				bpf__AddToCollection__pf(bpfv__CallFunc_Array_Get_Item__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		case 8:
		...
		case 9:
			{
				...
				bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf = UKismetMathLibrary::Subtract_FloatFloat(bpp__Time__pf, bpfv__CallFunc_Divide_FloatFloat_ReturnValue__pf);
				bpfv__CallFunc_FClamp_ReturnValue__pf = UKismetMathLibrary::FClamp(bpfv__CallFunc_Subtract_FloatFloat_ReturnValue__pf, 0.000000, 1.000000);
				bpf__MoveButton__pf(bpfv__CallFunc_FClamp_ReturnValue__pf, bpfv__CallFunc_Array_Get_Item__pf);
				__CurrentState = (__StateStack.Num() > 0) ? __StateStack.Pop(/*bAllowShrinking=*/ false) : -1;
				break;
			}
		default:
...
void ABP_AddDynamic_C__pf3034317442::bpf__AddToCollection__pf(AUxtPressableButtonActor* const& bpp__ActorToAdd__pf__const)
{
	typedef AUxtPressableButtonActor*  T__Local__55;
	T__Local__55& bpp__ActorToAdd__pf = *const_cast<T__Local__55 *>(&bpp__ActorToAdd__pf__const);
	bool bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf{};
	bpfv__CallFunc_Array_RemoveItem_ReturnValue__pf = FCustomThunkTemplates::Array_RemoveItem(bpv__Buttons__pf, bpp__ActorToAdd__pf);
	if(::IsValid(bpv__ScrollingObjectCollection__pf) && ::IsValid(bpv__ScrollingObjectCollection__pf->bpv__UxtScrollingObjectCollection__pf))
	{
		bpv__ScrollingObjectCollection__pf->bpv__UxtScrollingObjectCollection__pf->UUxtScrollingObjectCollection::AddActorToCollection(bpp__ActorToAdd__pf);
	}
}
void ABP_AddDynamic_C__pf3034317442::bpf__MoveButton__pf(float bpp__Time__pf, AActor* bpp__ActorToMove__pf)
{
	FVector bpfv__CallFunc_GetLocationAtTime_ReturnValue__pf(EForceInit::ForceInit);
	FRotator bpfv__CallFunc_GetRotationAtTime_ReturnValue__pf(EForceInit::ForceInit);
	FHitResult bpfv__CallFunc_K2_SetActorLocationAndRotation_SweepHitResult__pf{};
	bool bpfv__CallFunc_K2_SetActorLocationAndRotation_ReturnValue__pf{};
	if(::IsValid(bpv__Spline__pf))
	{
		bpfv__CallFunc_GetLocationAtTime_ReturnValue__pf = bpv__Spline__pf->USplineComponent::GetLocationAtTime(bpp__Time__pf, ESplineCoordinateSpace::World, false);
	}
	if(::IsValid(bpv__Spline__pf))
	{
		bpfv__CallFunc_GetRotationAtTime_ReturnValue__pf = bpv__Spline__pf->USplineComponent::GetRotationAtTime(bpp__Time__pf, ESplineCoordinateSpace::World, false);
	}
	if(::IsValid(bpp__ActorToMove__pf))
	{
		bpfv__CallFunc_K2_SetActorLocationAndRotation_ReturnValue__pf = bpp__ActorToMove__pf->AActor::K2_SetActorLocationAndRotation(bpfv__CallFunc_GetLocationAtTime_ReturnValue__pf, bpfv__CallFunc_GetRotationAtTime_ReturnValue__pf, false, /*out*/ bpfv__CallFunc_K2_SetActorLocationAndRotation_SweepHitResult__pf, false);
	}
}
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AddDynamic_C__pf3034317442::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void ABP_AddDynamic_C__pf3034317442::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	__StaticDependencies_DirectlyUsedAssets(AssetsToLoad);
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		{158, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.SplineComponent 
		...
		{159, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.TimelineComponent 
		...
		{151, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/UXTools.UxtScrollingObjectCollection 
		...
		{160, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Enum /Script/Engine.ETimelineDirection 
		...
		{152, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  ScriptStruct /Script/UXTools.ScrollingCollectionProperties 
		...
		{157, FBlueprintDependencyType(false, true, false, false), FBlueprintDependencyType(false, false, false, false)},  //  BlueprintGeneratedClass /UXToolsExamples/ScrollingObjectCollection/Blueprints/BP_ScrollingObjectCollection.BP_ScrollingObjectCollection_C 
	};
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__ABP_AddDynamic_C__pf3034317442
{
	FRegisterHelper__ABP_AddDynamic_C__pf3034317442()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/UXToolsExamples/ScrollingObjectCollection/Blueprints/BP_AddDynamic"), &ABP_AddDynamic_C__pf3034317442::__StaticDependenciesAssets);
	}
	static FRegisterHelper__ABP_AddDynamic_C__pf3034317442 Instance;
};
FRegisterHelper__ABP_AddDynamic_C__pf3034317442 FRegisterHelper__ABP_AddDynamic_C__pf3034317442::Instance;
