...
#include "../Plugins/Marketplace/UXTools/Source/UXTools/Public/Input/UxtHandInteractionActor.h"
...
#include "../Plugins/Marketplace/UXTools/Source/UXTools/Private/Input/UxtHandMeshCollisionDeactivationComponent.h"
...
AMRPawn_C__pf2645888192::AMRPawn_C__pf2645888192(const FObjectInitializer& ObjectInitializer) : Super()
{
	
	auto __Local__0 = CastChecked<USphereComponent>(this->GetDefaultSubobjectByName(TEXT("CollisionComponent0")), ECastCheckedType::NullAllowed);
	auto __Local__1 = CastChecked<UFloatingPawnMovement>(this->GetDefaultSubobjectByName(TEXT("MovementComponent0")), ECastCheckedType::NullAllowed);
	auto __Local__2 = CastChecked<UStaticMeshComponent>(this->GetDefaultSubobjectByName(TEXT("MeshComponent0")), ECastCheckedType::NullAllowed);
	if(__Local__0)
	{
		// --- Default subobject 'CollisionComponent0' //
		...
		// --- END default subobject 'CollisionComponent0' //
	}
	if(__Local__1)
	{
		// --- Default subobject 'MovementComponent0' //
		__Local__1->MaxSpeed = 20.000000f;
		...
		// --- END default subobject 'MovementComponent0' //
	}
	if(__Local__2)
	{
		// --- Default subobject 'MeshComponent0' //
		auto& __Local__9 = (*(AccessPrivateProperty<USphereComponent*>((__Local__2), USceneComponent::__PPO__AttachParent() )));
		...
		// --- END default subobject 'MeshComponent0' //
	}
	MovementComponent = __Local__1;
	auto& __Local__12 = (*(AccessPrivateProperty<USphereComponent*>((this), ADefaultPawn::__PPO__CollisionComponent() )));
	__Local__12 = __Local__0;
	auto& __Local__13 = (*(AccessPrivateProperty<UStaticMeshComponent*>((this), ADefaultPawn::__PPO__MeshComponent() )));
...
void AMRPawn_C__pf2645888192::PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph)
{
	Super::PostLoadSubobjects(OuterInstanceGraph);
}
PRAGMA_DISABLE_OPTIMIZATION
void AMRPawn_C__pf2645888192::__CustomDynamicClassInitialization(UDynamicClass* InDynamicClass)
{
...
PRAGMA_ENABLE_OPTIMIZATION
void AMRPawn_C__pf2645888192::bpf__ExecuteUbergraph_MRPawn__pf_0(int32 bpp__EntryPoint__pf)
{
	...
	AUxtHandInteractionActor* bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf{};
	AUxtHandInteractionActor* bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf{};
	...
	do
	{
		...
		case 1:
			{
				...
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AUxtHandInteractionActor::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::Undefined, ((AActor*)nullptr));
			}
		case 2:
			{
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_FinishSpawningActor_ReturnValue__pf = CastChecked<AUxtHandInteractionActor>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
			}
		case 3:
			{
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf = UGameplayStatics::BeginDeferredActorSpawnFromClass(this, AUxtHandInteractionActor::StaticClass(), bpfv__CallFunc_MakeTransform_ReturnValue__pf, ESpawnActorCollisionHandlingMethod::Undefined, ((AActor*)nullptr));
			}
		case 4:
			{
		...
		case 5:
			{
				bpfv__CallFunc_MakeTransform_ReturnValue__pf = UKismetMathLibrary::MakeTransform(FVector(0.000000,0.000000,0.000000), FRotator(0.000000,0.000000,0.000000), FVector(1.000000,1.000000,1.000000));
				bpfv__CallFunc_FinishSpawningActor_ReturnValue_1__pf = CastChecked<AUxtHandInteractionActor>(UGameplayStatics::FinishSpawningActor(bpfv__CallFunc_BeginDeferredActorSpawnFromClass_ReturnValue_1__pf, bpfv__CallFunc_MakeTransform_ReturnValue__pf), ECastCheckedType::NullAllowed);
...
void AMRPawn_C__pf2645888192::bpf__ReceiveBeginPlay__pf()
{
	bpf__ExecuteUbergraph_MRPawn__pf_0(6);
}
PRAGMA_DISABLE_OPTIMIZATION
void AMRPawn_C__pf2645888192::__StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
}
PRAGMA_ENABLE_OPTIMIZATION
PRAGMA_DISABLE_OPTIMIZATION
void AMRPawn_C__pf2645888192::__StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad)
{
	...
	const FCompactBlueprintDependencyData LocCompactBlueprintDependencyData[] =
	{
		...
		{22, FBlueprintDependencyType(true, false, false, false), FBlueprintDependencyType(false, false, false, false)},  //  Class /Script/Engine.DefaultPawn 
...
PRAGMA_ENABLE_OPTIMIZATION
struct FRegisterHelper__AMRPawn_C__pf2645888192
{
	FRegisterHelper__AMRPawn_C__pf2645888192()
	{
		FConvertedBlueprintsDependencies::Get().RegisterConvertedClass(TEXT("/UXToolsExamples/Common/GameMode/MRPawn"), &AMRPawn_C__pf2645888192::__StaticDependenciesAssets);
	}
	static FRegisterHelper__AMRPawn_C__pf2645888192 Instance;
};
FRegisterHelper__AMRPawn_C__pf2645888192 FRegisterHelper__AMRPawn_C__pf2645888192::Instance;
