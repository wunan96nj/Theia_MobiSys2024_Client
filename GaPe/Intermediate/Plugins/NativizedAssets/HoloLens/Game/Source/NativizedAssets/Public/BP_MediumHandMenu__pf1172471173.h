...
#include "BP_MediumHandMenu__pf1172471173.generated.h"
UCLASS(config=Engine, Blueprintable, BlueprintType, meta=(ReplaceConverted="/UXToolsExamples/HandMenu/Blueprints/BP_MediumHandMenu.BP_MediumHandMenu_C", OverrideNativeName="BP_MediumHandMenu_C"))
class ABP_MediumHandMenu_C__pf1172471173 : public AActor
{
public:
	GENERATED_BODY()
	...
	ABP_MediumHandMenu_C__pf1172471173(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
	virtual void PostLoadSubobjects(FObjectInstancingGraph* OuterInstanceGraph) override;
	static void __CustomDynamicClassInitialization(UDynamicClass* InDynamicClass);
	static void __StaticDependenciesAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	static void __StaticDependencies_DirectlyUsedAssets(TArray<FBlueprintDependencyData>& AssetsToLoad);
	void bpf__ExecuteUbergraph_BP_MediumHandMenu__pf_0(int32 bpp__EntryPoint__pf);
	void bpf__ExecuteUbergraph_BP_MediumHandMenu__pf_1(int32 bpp__EntryPoint__pf);
